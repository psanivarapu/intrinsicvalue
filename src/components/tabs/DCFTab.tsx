...
export function DCFTab() {
  ...
  const netDebtAdj = isAdv && !isFCFF ? 0 : netDebt
              ...
              {result.impliedExitMultiple !== undefined && (
                <div className="mb-2 p-2 bg-gray-50 border border-gray-200 rounded text-xs text-gray-600">
                  ...
                  {dcf.sectorNormEVEBITDA !== '' && result.impliedExitMultiple > (dcf.sectorNormEVEBITDA as number) && (
                    <span className="ml-1 text-amber-600">⚠ exceeds sector norm of {dcf.sectorNormEVEBITDA}×</span>
                  )}
                </div>
              )}
      ...
      <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {baseCF !== 0 && (
                <div className="flex items-end pb-1.5">
                  <div className="text-xs px-2 py-1 bg-indigo-50 rounded border border-indigo-100 text-indigo-700 w-full">
        ...
        {isAdv && !isFCFF && (
          <>
            ...
            {baseCF !== 0 && (
              <div className="text-xs px-2 py-1 bg-indigo-50 rounded border border-indigo-100 text-indigo-700 inline-block">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 items-end">
          <NumberInput
            label={isAdv ? 'Stage 1 Growth (yrs 1–5)' : 'Growth (yrs 1–10)'}
            unit="%"
        ...
        {!isAdv && (
          <p className="text-xs text-gray-400">
            Simple mode uses cost of equity and subtracts net debt to estimate equity value. Switch to Advanced for a full WACC/FCFF analysis.
          </p>
        )}
